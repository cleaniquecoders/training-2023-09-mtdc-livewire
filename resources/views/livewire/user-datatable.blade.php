<div>
    <div wire:offline class="flex items-center w-full text-center">
        This device is currently offline.
    </div>
    <div wire:offline.class="bg-gray-100 blur-sm disabled">

        <div class="my-4 flex justify-between">

            <div class="flex items-center">
                <x-input class="block mt-1" placeholder="Search Keyword" type="text"
            ...
            <table class="min-w-full divide-y divide-gray-300">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            <x-sortable field="email_verified_at" :sortBy="$sortBy" :sortDir="$sortDir"
                                title="Verified At" />
                        </th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
